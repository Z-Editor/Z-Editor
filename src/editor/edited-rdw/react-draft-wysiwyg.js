module.exports = function (e) {
  ...
  */
  ! function () {
    ...
    void 0 !== e && e.exports ? e.exports = r : "object" === a(n(9)) && n(9) ? (o = [], void 0 !== (i = function () {
      return r
    }.apply(t, o)) && (e.exports = i)) : window.classNames = r
  }()
}, function (e, t) {
  ...
  var I = function (e) {
    function t() {
      ...
      return n = o = r(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(M))), o.onClick = function () {
        var e = o.props,
          t = e.disabled,
          n = e.onClick,
          i = e.value;
    ...
    return l(t, e), M(t, [{
      ...
      value: function () {
        ...
        return s.default.createElement("div", {
          className: (0, N.default)("rdw-option-wrapper", o, (e = {}, i(e, "rdw-option-active " + a, r), i(e, "rdw-option-disabled", l), e)),
  ...
  e.exports = function (e) {
    ...
    function o(e) {
      var t = e.getSelection(),
        ...
        i = t.getEndKey(),
        a = n.getBlockMap();
      return a.toSeq().skipUntil(function (e, t) {
        return t === o
    ...
    function r(e) {
      return e ? e.getCurrentContent().getBlockMap().toList() : new D.List
    }
    ...
    function s(e) {
      ...
      return o = I.Modifier.insertText(o, i, "\n", a.getInlineStyleAt(i.getStartOffset()), null), I.EditorState.push(e, o, "insert-fragment")
    }
      ...
      if (n && n.size > 0)
        for (var o = 0; o < n.size; o += 1) {
          var a = function (e) {
            ...
            if (0 === e) t = o;
            else if (t.forEach(function (e, n) {
                o.get(n) && o.get(n) === e || (t = t.delete(n))
              }), 0 === t.size) return t = t.clear(), "break"
          }(o);
          if ("break" === a) break
        }
      return t
    ...
    Object.defineProperty(t, "__esModule", {
      value: !0
    }), t.getSelectedBlocksMap = o, t.getSelectedBlocksList = i, t.getSelectedBlock = a, t.getAllBlocks = r, t.getSelectedBlocksType = l, t.removeSelectedBlocksStyle = M, t.getSelectionText = c, t.addLineBreakRemovingSelection = s, t.insertNewUnstyledBlock = g, t.clearEditorContent = u, t.setBlockData = d, t.getSelectedBlocksMetadata = N;
    var I = n(1),
      D = n(6)
  }, function (e, t) {
    e.exports = n(3)
    ...
    Object.defineProperty(t, "__esModule", {
      value: !0
    }), t.isListBlock = o, t.changeDepth = a;
    var r = n(1),
      l = n(0)
  }, function (e, t, n) {
    "use strict";
      ...
      if (r.size > 0) {
        var l = function () {
          for (var e = {
            ...
            for (var l = n; l < o; l += 1) ! function (n) {
    ...
    function r(e, t) {
      var n = (0, D.getSelectedBlock)(e),
        o = void 0;
      return n.findEntityRanges(function (e) {
    ...
    function l(e, t, n) {
      ...
      if (o.isCollapsed() && (a = r.reduce(function (e, t) {
          return I.RichUtils.toggleInlineStyle(e, t)
        }, a)), "SUPERSCRIPT" === t || "SUBSCRIPT" == t) r.has(n) || (a = I.RichUtils.toggleInlineStyle(a, n));
      else {
    ...
    function M(e) {
      e && e.getCurrentContent().getBlockMap().map(function (e) {
        ...
        e && 0 === e.indexOf("color-") ? j("color", "color", e.substr(6)) : e && 0 === e.indexOf("bgcolor-") ? j("bgcolor", "backgroundColor", e.substr(8)) : e && 0 === e.indexOf("fontsize-") ? j("fontSize", "fontSize", e.substr(9)) : e && 0 === e.indexOf("fontfamily-") && j("fontFamily", "fontFamily", e.substr(11))
      })
    }
      ...
      if (e && t && t.length > 0) {
        var n = function () {
          var n = e.getSelection(),
            o = {};
          if (n.isCollapsed) return t.forEach(function (t) {
            o[t] = s(e, t)
          }), {
            v: o
          };
          var i = n.getStartOffset(),
            ...
            r = (0, D.getSelectedBlocksList)(e);
          if (r.size > 0) {
            for (var l = 0; l < r.size; l += 1) ! function (e) {
              var n = 0 === e ? i : 0,
                l = e === r.size - 1 ? a : r.get(e).getText().length;
              n === l && 0 === n ? (n = 1, l = 2) : n === l && (n -= 1);
              for (var M = n; M < l; M += 1) ! function (i) {
    ...
    t.getSelectionInlineStyle = i, t.getSelectionEntity = a, t.getEntityRange = r, t.toggleCustomInlineStyle = l, t.extractInlineStyle = M, t.getSelectionCustomInlineStyle = g, t.removeAllInlineStyles = u;
    var I = n(1),
      D = n(0),
    ...
    function o(e) {
      ...
      if (t.isCollapsed()) {
        ...
        if (!(0, M.isListBlock)(i) && "unstyled" !== i.getType() && i.getLength() === t.getStartOffset()) return (0, l.insertNewUnstyledBlock)(e);
    ...
    function i(e) {
      return 13 === e.which && (e.getModifierState("Shift") || e.getModifierState("Alt") || e.getModifierState("Control"))
    }

    function a(e, t) {
      return i(t) ? e.getSelection().isCollapsed() ? r.RichUtils.insertSoftNewline(e) : (0, l.addLineBreakRemovingSelection)(e) : o(e)
    }
    Object.defineProperty(t, "__esModule", {
      value: !0
    }), t.default = a;
  ...
  Object.defineProperty(t, "__esModule", {
    value: !0
  }), t.forEach = o, t.hasProperty = i, t.isEmptyString = a, t.isMap = r, t.filter = l, t.stopPropagation = M
}, function (e, t, n) {
  "use strict";
  ...
  var o = n(6),
    ...
    a = function e(t, n) {
      ...
      var i = {};
      return (0, o.forEach)(t, function (t, a) {
  ...
  var R = function (e) {
    function t(e) {
      ...
      return n.wrapperId = "rdw-wrapper-" + i, n.modalHandler = new w.default, n.focusHandler = new y.default, n.blockRendererFn = (0, P.default)({
        isReadOnly: n.isReadOnly,
        isImageAlignmentEnabled: n.isImageAlignmentEnabled,
        getEditorState: n.getEditorState,
        onChange: n.onChange
      }, e.customBlockRenderFunc), n.editorProps = n.filterEditorProps(e), n.customStyleMap = (0, I.getCustomStyleMap)(), n
    }
    return l(t, e), c(t, [{
      ...
      value: function () {
        ...
        (0, I.extractInlineStyle)(e), this.setState({
          editorState: e
        })
      }
    }, {
      ...
      value: function (e) {
        ...
        if ((0, O.hasProperty)(e, "editorState") && this.props.editorState !== e.editorState) e.editorState ? t.editorState = N.EditorState.set(e.editorState, {
        ...
        t.editorState && (this.props.editorState && this.props.editorState.getCurrentContent().getBlockMap().size) !== (t.editorState && t.editorState.getCurrentContent().getBlockMap().size) && (0, I.extractInlineStyle)(t.editorState), this.setState(t), this.editorProps = this.filterEditorProps(e), this.customStyleMap = (0, I.getCustomStyleMap)()
      }
    }, {
      key: "render",
      value: function () {
        ...
        return g.default.createElement("div", {
          ...
          var n = S.default[e],
            i = o[e];
          return "image" === e && A && (i.uploadCallback = A), g.default.createElement(n, M({
            key: t
          }, m, {
            config: i
          }))
        }), s && s.map(function (e, t) {
          return g.default.cloneElement(e, M({
            key: t
          }, m))
        })), g.default.createElement("div", {
        ...
        }, g.default.createElement(N.Editor, M({
  ...
  var H = function () {
    ...
    this.onEditorBlur = function () {
      ...
      o || "atomic" === (0, I.getSelectedBlocksType)(t) && t.getSelection().isCollapsed || (i && i(t, e.props.wrapperId), (0, O.hasProperty)(e.props, "editorState") ? e.afterChange(t) : e.setState({
        editorState: t
      }, e.afterChange(t)))
      ...
      var t = [].concat(i(e.props.customDecorators), [(0, b.default)({
        showOpenOptionOnHover: e.state.toolbar.link.showOpenOptionOnHover
      })]);
      return e.props.mention && t.push.apply(t, i((0, v.default)(M({}, e.props.mention, {
        onChange: e.onChange,
        getEditorState: e.getEditorState,
        getSuggestions: e.getSuggestions,
        getWrapperRef: e.getWrapperRef,
        modalHandler: e.modalHandler
      })))), e.props.hashtag && t.push((0, Q.default)(e.props.hashtag)), new N.CompositeDecorator(t)
      ...
      var n = void 0;
      if ((0, O.hasProperty)(e.props, "editorState")) e.props.editorState && (n = N.EditorState.set(e.props.editorState, {
        decorator: t
      }));
      else if ((0, O.hasProperty)(e.props, "defaultEditorState")) e.props.defaultEditorState && (n = N.EditorState.set(e.props.defaultEditorState, {
        decorator: t
      }));
      ...
      } else if ((0, O.hasProperty)(e.props, "defaultContentState") || (0, O.hasProperty)(e.props, "initialContentState")) {
        var i = e.props.defaultContentState || e.props.initialContentState;
        i && (i = (0, N.convertFromRaw)(i), n = N.EditorState.createWithContent(i, t), n = N.EditorState.moveSelectionToEnd(n))
      }
  ...
  var i = function () {};
  i.thatReturns = o, i.thatReturnsFalse = o(!1), i.thatReturnsTrue = o(!0), i.thatReturnsNull = o(null), i.thatReturnsThis = function () {
    return this
  ...
  var i = function e() {
    var t = this;
    o(this, e), this.callBacks = [], this.suggestionCallback = void 0, this.editorFlag = !1, this.suggestionFlag = !1, this.closeAllModals = function (e) {
  ...
  var i = function e() {
    var t = this;
    o(this, e), this.inputFocused = !1, this.editorMouseDown = !1, this.onEditorMouseDown = function () {
      t.editorFocused = !0
    }, this.onInputMouseDown = function () {
      t.inputFocused = !0
    }, this.isEditorBlur = function (e) {
      return "INPUT" !== e.target.tagName || t.editorFocused ? "INPUT" !== e.target.tagName && !t.inputFocused && (t.editorFocused = !1, !0) : (t.inputFocused = !1, !0)
  ...
  var l = function () {
    ...
    p = function (e) {
      function t() {
        ...
        i(this, t);
        for (var l = arguments.length, M = Array(l), c = 0; c < l; c++) M[c] = arguments[c];
        return n = o = a(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(M))), o.state = {
          currentStyles: {}
          ...
          if (e) {
            var t = {};
            return (0, N.forEach)(e, function (e, n) {
      ...
      return r(t, e), l(t, [{
        ...
        key: "componentWillReceiveProps",
        value: function (e) {
          e.editorState && this.props.editorState !== e.editorState && this.setState({
    ...
    return r(t, e), l(t, [{
      ...
      value: function () {
        var e = this.props,
          ...
          u = t.title;
        return c.default.createElement(p.Dropdown, {
          ...
          return c.default.createElement(p.DropdownOption, {
            key: n,
            value: e,
  ...
  var I = function (e) {
    function t() {
      ...
      a(this, t);
      for (var l = arguments.length, M = Array(l), c = 0; c < l; c++) M[c] = arguments[c];
      return n = o = r(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(M))), o.onClick = function (e) {
        var t = o.props,
          n = t.onSelect,
          i = t.onClick,
          a = t.value;
    ...
    return l(t, e), M(t, [{
      ...
      value: function () {
        ...
        return s.default.createElement("li", {
          className: (0, N.default)("rdw-dropdownoption-default", l, (e = {}, i(e, "rdw-dropdownoption-active " + M, o), i(e, "rdw-dropdownoption-highlighted " + g, r), i(e, "rdw-dropdownoption-disabled " + c, a), e)),
  ...
  var p = function (e) {
    function t(e) {
      ...
      return n.getBlockTypes = function (e) {
        return [{
          label: "Normal",
    ...
    return r(t, e), l(t, [{
      key: "componentWillReceiveProps",
      value: function (e) {
        this.props.translations !== e.translations && this.setState({
      ...
      value: function (e) {
        ...
        }, c.default.createElement(D.Dropdown, {
        ...
        }, c.default.createElement("span", null, j || N["components.controls.blocktype.blocktype"]), e.map(function (e, t) {
          return c.default.createElement(D.DropdownOption, {
            active: r === e.label,
            value: e.label,
            key: t
          }, e.displayName)
    ...
    return r(t, e), l(t, [{
      ...
      value: function () {
        ...
        if (e && e.length > 0) {
          ...
          n = n.substring(0, n.length - 2), this.setState({
            defaultFontSize: n
          })
        }
      }
      ...
      value: function () {
        ...
        return p = Number(p), D = D || a && a.indexOf(p) >= 0 && p, c.default.createElement("div", {
          className: "rdw-fontsize-wrapper",
          "aria-label": "rdw-font-size-control"
        }, c.default.createElement(N.Dropdown, {
        ...
        }, D ? c.default.createElement("span", null, D) : c.default.createElement("img", {
          src: n,
          alt: ""
        }), a.map(function (e, t) {
          return c.default.createElement(N.DropdownOption, {
  ...
  var I = function (e) {
    ...
    return r(t, e), l(t, [{
      ...
      value: function () {
        ...
        return D = D || a && e && a.some(function (t) {
        ...
        }, D || l["components.controls.fontfamily.fontfamily"]), a.map(function (e, t) {
          return c.default.createElement(N.DropdownOption, {
            active: D === e,
            value: e,
            key: t
    ...
    D = function (e) {
      function t() {
        ...
        return n = o = a(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(M))), o.state = {
          ...
          "unordered" === e ? o.toggleBlockType("unordered-list-item") : "ordered" === e ? o.toggleBlockType("ordered-list-item") : "indent" === e ? o.adjustDepth(1) : o.adjustDepth(-1)
        }, o.expandCollapse = function () {
          o.setState({
            expanded: o.signalExpanded
          }), o.signalExpanded = !1
      ...
      return r(t, e), l(t, [{
        ...
        value: function () {
          var e = this.props,
            ...
            r = t.component || I.default,
            l = void 0;
          return "unordered-list-item" === a ? l = "unordered" : "ordered-list-item" === a && (l = "ordered"), c.default.createElement(r, {
            config: t,
            translations: n,
            currentState: {
              listType: l
  ...
  var j = function (e) {
    function t() {
      ...
      i(this, t);
      for (var l = arguments.length, M = Array(l), c = 0; c < l; c++) M[c] = arguments[c];
      return n = o = a(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(M))), o.options = ["unordered", "ordered", "indent", "outdent"], o.toggleBlockType = function (e) {
    ...
    return r(t, e), l(t, [{
      ...
      value: function () {
        ...
        return c.default.createElement("div", {
        ...
        }, i.indexOf("unordered") >= 0 && c.default.createElement(p.default, {
          value: "unordered",
          ...
          src: a.icon,
          alt: ""
        })), i.indexOf("ordered") >= 0 && c.default.createElement(p.default, {
          value: "ordered",
          onClick: this.toggleBlockType,
          ...
          src: r.icon,
          alt: ""
        })), i.indexOf("indent") >= 0 && c.default.createElement(p.default, {
          onClick: this.indent,
          ...
          src: l.icon,
          alt: ""
        })), i.indexOf("outdent") >= 0 && c.default.createElement(p.default, {
      ...
      value: function () {
        var e = this.props,
          ...
          D = t.title;
        return c.default.createElement(I.Dropdown, {
          ...
          return c.default.createElement(I.DropdownOption, {
            key: n,
            value: e,
  ...
  var l = function () {
    ...
    I = function (e) {
      function t() {
        ...
        return n = o = a(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(M))), o.state = {
          ...
          var t = o.props,
            n = t.editorState,
            i = t.onChange;
          i(o.state.currentTextAlignment !== e ? (0, u.setBlockData)(n, {
            "text-align": e
          }) : (0, u.setBlockData)(n, {
            "text-align": void 0
          }))
      ...
      return r(t, e), l(t, [{
        ...
        key: "componentWillReceiveProps",
        value: function (e) {
          e.editorState !== this.props.editorState && this.setState({
  ...
  var j = function (e) {
    ...
    return r(t, e), l(t, [{
      ...
      value: function () {
        ...
        return c.default.createElement("div", {
        ...
        }, n.indexOf("left") >= 0 && c.default.createElement(I.default, {
          value: "left",
          ...
          src: o.icon,
          alt: ""
        })), n.indexOf("center") >= 0 && c.default.createElement(I.default, {
          value: "center",
          ...
          src: i.icon,
          alt: ""
        })), n.indexOf("right") >= 0 && c.default.createElement(I.default, {
          value: "right",
          className: (0, d.default)(a.className),
          active: "right" === s,
          onClick: M,
          ...
          src: a.icon,
          alt: ""
        })), n.indexOf("justify") >= 0 && c.default.createElement(I.default, {
          value: "justify",
          className: (0, d.default)(r.className),
          active: "justify" === s,
          onClick: M,
      ...
      value: function () {
        var e = this.props,
          ...
          C = t.title;
        return c.default.createElement(D.Dropdown, {
          ...
          alt: ""
        }), s.indexOf("left") >= 0 && c.default.createElement(D.DropdownOption, {
          value: "left",
          active: "left" === r,
          ...
          src: g.icon,
          alt: ""
        })), s.indexOf("center") >= 0 && c.default.createElement(D.DropdownOption, {
          value: "center",
          active: "center" === r,
          ...
          src: u.icon,
          alt: ""
        })), s.indexOf("right") >= 0 && c.default.createElement(D.DropdownOption, {
          value: "right",
          active: "right" === r,
          ...
          src: N.icon,
          alt: ""
        })), s.indexOf("justify") >= 0 && c.default.createElement(D.DropdownOption, {
          value: "justify",
          active: "justify" === r,
  ...
  var l = function () {
    ...
    I = function (e) {
      ...
      return r(t, e), l(t, [{
        ...
        value: function (e) {
          var t = {};
          e.editorState && this.props.editorState !== e.editorState && (t.currentColor = (0, u.getSelectionCustomInlineStyle)(e.editorState, ["COLOR"]).COLOR, t.currentBgColor = (0, u.getSelectionCustomInlineStyle)(e.editorState, ["BGCOLOR"]).BGCOLOR), this.setState(t)
        }
      }, {
        key: "componentWillUnmount",
        value: function () {
  ...
  var p = function (e) {
    function t() {
      ...
      return n = o = a(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(M))), o.state = {
        ...
        }, M["components.controls.colorpicker.text"]), c.default.createElement("span", {
          className: (0, d.default)("rdw-colorpicker-modal-style-label", {
            "rdw-colorpicker-modal-style-label-active": "bgcolor" === s
          }),
          onClick: o.setCurrentStyleBgcolor
        }, M["components.controls.colorpicker.background"])), c.default.createElement("span", {
      ...
      function t() {
        ...
        return n = o = a(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(M))), o.state = {
          ...
          if (t && "LINK" === n.getEntity(t).get("type")) {
            ...
            i.link.target = t && n.getEntity(t).get("data").url, i.link.targetOption = t && n.getEntity(t).get("data").target, i.link.title = a && a.text
          }
          ...
          var s = a.getCurrentContent().createEntity("LINK", "MUTABLE", {
              url: t,
              target: n
          ...
          }), N = u.EditorState.acceptSelection(N, M), g = u.Modifier.insertText(N.getCurrentContent(), M, " ", N.getCurrentInlineStyle(), void 0), r(u.EditorState.push(N, g, "insert-characters")), o.doCollapse()
        }, r = n, a(o, r)
      }
      return r(t, e), l(t, [{
        key: "componentWillMount",
        ...
        value: function (e) {
          var t = {};
          e.editorState && this.props.editorState !== e.editorState && (t.currentEntity = (0, d.getSelectionEntity)(e.editorState)), this.setState(t)
        }
      }, {
        key: "componentWillUnmount",
        value: function () {
  ...
  var C = function (e) {
    function t() {
      ...
      return n = o = r(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(c))), o.state = {
        showModal: !1,
        linkTarget: "",
        linkTitle: "",
    ...
    return l(t, e), M(t, [{
      ...
      value: function () {
        ...
        return s.default.createElement("div", {
        ...
        }, o["components.controls.link.linkTitle"]), s.default.createElement("input", {
          ...
          className: "rdw-link-modal-label"
        }, o["components.controls.link.linkTarget"]), s.default.createElement("input", {
          className: "rdw-link-modal-input",
          onChange: this.updateValue,
          onBlur: this.updateValue,
          name: "linkTarget",
        ...
        }), s.default.createElement("span", null, o["components.controls.link.linkTargetOption"])), s.default.createElement("span", {
          className: "rdw-link-modal-buttonsection"
        }, s.default.createElement("button", {
          className: "rdw-link-modal-btn",
          onClick: this.addLink,
          disabled: !r || !a
        }, o["generic.add"]), s.default.createElement("button", {
          className: "rdw-link-modal-btn",
          onClick: n
        }, o["generic.cancel"])))
      }
      ...
      value: function () {
        ...
        return s.default.createElement("div", {
        ...
        }, n.indexOf("link") >= 0 && s.default.createElement(j.default, {
          ...
          src: o.icon,
          alt: ""
        })), n.indexOf("unlink") >= 0 && s.default.createElement(j.default, {
          disabled: !r.link,
      ...
      value: function () {
        ...
        return s.default.createElement("div", {
          ...
          "aria-expanded": t,
          title: p
        }, s.default.createElement(w.Dropdown, {
          ...
          alt: ""
        }), c.indexOf("link") >= 0 && s.default.createElement(w.DropdownOption, {
          ...
          src: g.icon,
          alt: ""
        })), c.indexOf("unlink") >= 0 && s.default.createElement(w.DropdownOption, {
          onClick: this.removeLink,
          disabled: !l.link,
      ...
      function t() {
        ...
        return n = o = a(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(M))), o.state = {
          ...
          var i = o.props,
            a = i.editorState,
            r = i.onChange,
            l = a.getCurrentContent().createEntity("EMBEDDED_LINK", "MUTABLE", {
              src: e,
              height: t,
              width: n
            }).getLastCreatedEntityKey();
  ...
  var j = function (e) {
    ...
    return l(t, e), M(t, [{
      ...
      value: function () {
        ...
        return s.default.createElement("div", {
        ...
        }, l["components.controls.embedded.embeddedlink"], s.default.createElement("span", {
        ...
        }, s.default.createElement("span", null, s.default.createElement("input", {
          onChange: this.updateValue,
          onBlur: this.updateValue,
          value: n,
          name: "height",
          ...
          disabled: !t || !n || !o
        }, l["generic.add"]), s.default.createElement("button", {
          type: "button",
          className: "rdw-embedded-modal-btn",
          onClick: r
        }, l["generic.cancel"])))
  ...
  var p = function (e) {
    function t() {
      ...
      i(this, t);
      for (var l = arguments.length, M = Array(l), c = 0; c < l; c++) M[c] = arguments[c];
      return n = o = a(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(M))), o.onChange = function (e) {
    ...
    I = function (e) {
      function t() {
        ...
        return n = o = a(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(M))), o.state = {
          ...
          var s = r.getCurrentContent().createEntity("IMAGE", "MUTABLE", c).getLastCreatedEntityKey();
  ...
  var w = function (e) {
    function t() {
      ...
      return n = o = r(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(c))), o.state = {
        ...
        o.stopPropagation(e), o.setState({
          dragEnter: !0
        })
      }, o.onImageDrop = function (e) {
        e.preventDefault(), e.stopPropagation(), o.setState({
          dragEnter: !1
        });
        var t = void 0,
          n = void 0;
        ...
        o.toggleShowImageLoading(), (0, o.props.config.uploadCallback)(e).then(function (e) {
          var t = e.data;
          o.setState({
            showImageLoading: !1,
            dragEnter: !1,
    ...
    return l(t, e), M(t, [{
      ...
      value: function (e) {
        this.props.expanded && !e.expanded ? this.setState({
          ...
          alt: ""
        }) : e.config.uploadCallback === this.props.config.uploadCallback && e.config.uploadEnabled === this.props.config.uploadEnabled || this.setState({
      ...
      value: function () {
        ...
        return s.default.createElement("div", {
        ...
        }, d && u && s.default.createElement("span", {
          onClick: this.showImageUploadOption,
          className: "rdw-image-modal-header-option"
        }, C["components.controls.image.fileUpload"], s.default.createElement("span", {
          ...
          className: "rdw-image-modal-header-option"
        }, C["components.controls.image.byURL"], s.default.createElement("span", {
          className: (0, N.default)("rdw-image-modal-header-label", {
            "rdw-image-modal-header-label-highlighted": !n
          })
        ...
        }, t || C["components.controls.image.dropFileText"])), s.default.createElement("input", {
          type: "file",
          id: "file",
          accept: D,
          ...
          className: "rdw-image-mandatory-sign"
        }, "*")), p.present && s.default.createElement("div", {
          className: "rdw-image-modal-size"
        }, s.default.createElement("span", {
          className: "rdw-image-modal-alt-lbl"
        }, "Alt Text"), s.default.createElement("input", {
          onChange: this.updateValue,
          onBlur: this.updateValue,
          value: l,
          name: "alt",
          ...
          className: "rdw-image-mandatory-sign"
        }, p.mandatory && "*")), s.default.createElement("div", {
          className: "rdw-image-modal-size"
        }, "↕ ", s.default.createElement("input", {
          onChange: this.updateValue,
          onBlur: this.updateValue,
        ...
        }, C["generic.add"]), s.default.createElement("button", {
          className: "rdw-image-modal-btn",
          onClick: w
        }, C["generic.cancel"])), o ? s.default.createElement("div", {
          className: "rdw-image-modal-spinner"
        }, s.default.createElement(j.default, null)) : void 0)
      }
    }, {
      key: "render",
      value: function () {
    ...
    p = function (e) {
      function t() {
        ...
        return n = o = a(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(M))), o.state = {
          ...
          var t = e.getCurrentContent();
          ["BOLD", "ITALIC", "UNDERLINE", "STRIKETHROUGH", "MONOSPACE", "SUPERSCRIPT", "SUBSCRIPT"].forEach(function (n) {
          ...
          return (0, N.forEach)(n, function (n, o) {
    ...
    return r(t, e), l(t, [{
      ...
      value: function () {
        ...
        return c.default.createElement(p.Dropdown, {
          ...
          src: (0, N.getFirstIcon)(t),
          alt: ""
        }), g.indexOf("undo") >= 0 && c.default.createElement(p.DropdownOption, {
          value: "undo",
          onClick: this.onChange,
          disabled: l,
          ...
          src: u.icon,
          alt: ""
        })), g.indexOf("redo") >= 0 && c.default.createElement(p.DropdownOption, {
          value: "redo",
          onClick: this.onChange,
          disabled: M,
      ...
      value: function () {
        ...
        return c.default.createElement("div", {
          ...
          "aria-label": "rdw-history-control"
        }, n.indexOf("undo") >= 0 && c.default.createElement(D.default, {
          value: "undo",
          onClick: this.onChange,
          className: (0, d.default)(o.className),
          disabled: l,
          ...
          src: o.icon,
          alt: ""
        })), n.indexOf("redo") >= 0 && c.default.createElement(D.default, {
          value: "redo",
          onClick: this.onChange,
          className: (0, d.default)(i.className),
          disabled: M,
  ...
  function M(e) {
    var t, n, o = e.showOpenOptionOnHover;
      ...
      return r(t, e), c(t, [{
        ...
        value: function () {
          ...
          return g.default.createElement("span", {
            ...
            href: r,
            target: l
          }, t), M && o ? g.default.createElement("img", {
            src: I.default,
            alt: "",
  ...
  function l() {
    ...
    return t = e = function (e) {
      function t() {
        ...
        r(this, t);
        for (var M = arguments.length, c = Array(M), s = 0; s < M; s++) c[s] = arguments[s];
        return o = a = i(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(c))), a.state = {
          style: {
            left: 15
          },
          activeOption: -1,
          ...
          var t = a.state.activeOption,
            n = {};
          "ArrowDown" === e.key ? (e.preventDefault(), t === a.filteredSuggestions.length - 1 ? n.activeOption = 0 : n.activeOption = t + 1) : "ArrowUp" === e.key ? n.activeOption = t <= 0 ? a.filteredSuggestions.length - 1 : t - 1 : "Escape" === e.key ? (n.showSuggestions = !1, C.default.close()) : "Enter" === e.key && a.addMention(), a.setState(n)
          ...
          var t = e.children[0].props.text.substr(1),
            o = n.getSuggestions();
          a.filteredSuggestions = o && o.filter(function (e) {
            return !t || 0 === t.length || (n.caseSensitive ? e.value.indexOf(t) >= 0 : e.value.toLowerCase().indexOf(t && t.toLowerCase()) >= 0)
          })
      ...
      return a(t, e), M(t, [{
        ...
        value: function () {
          var e = n.getWrapperRef().getBoundingClientRect(),
            ...
            a = void 0,
            r = void 0;
          e.width < t.left - e.left + o.width ? a = 15 : i = 15, e.bottom < o.bottom && (r = 0), this.setState({
            style: {
              left: i,
              right: a,
              bottom: r
            }
          }), j.default.registerCallBack(this.onEditorKeyDown), C.default.open(), n.modalHandler.setSuggestionCallback(this.closeSuggestionDropdown), this.filterSuggestions(this.props)
        }
      }, {
        key: "componentWillReceiveProps",
        value: function (e) {
        ...
        key: "componentWillUnmount",
        value: function () {
          j.default.deregisterCallBack(this.onEditorKeyDown), C.default.close(), n.modalHandler.removeSuggestionCallback()
        }
      }, {
        key: "render",
        value: function () {
          ...
          }, s.default.createElement("span", null, t), a && s.default.createElement("span", {
        ...
        if (e.config.getEditorState()) {
          ...
          if (M.get("anchorKey") === t.get("key") && M.get("anchorKey") === M.get("focusKey")) {
            ...
            if ((void 0 === s || s < 0) && c[0] === a && (s = 0, g = a), s >= 0) {
              ...
              r().some(function (t) {
                return !!t.value && (e.config.caseSensitive ? t.value.indexOf(u) >= 0 : t.value.toLowerCase().indexOf(u && u.toLowerCase()) >= 0)
              }) && n(0 === s ? 0 : s + 1, c.length)
            }
          }
        }
      }, this.getSuggestionComponent = l.bind(this), this.getSuggestionDecorator = function () {
        return {
  ...
  function o(e, t, n, o, r) {
    ...
    D = i.EditorState.push(D, p, "insert-characters"), N || (I = D.getSelection().merge({
      anchorOffset: u + l.length + o.length,
      focusOffset: u + l.length + o.length
    }), D = i.EditorState.acceptSelection(D, I), p = i.Modifier.insertText(D.getCurrentContent(), I, " ", D.getCurrentInlineStyle(), void 0)), t(i.EditorState.push(D, p, "insert-characters"))
  }
  Object.defineProperty(t, "__esModule", {
    value: !0
  }), t.default = o;
  ...
  var g = function e(t) {
      var n = this;
      i(this, e), this.getHashtagComponent = function () {
        var e = n.className,
          t = function (t) {
            var n = t.children,
              o = n[0].props.text;
        ...
        for (var o = e.getText(), i = 0, a = 0; o.length > 0 && i >= 0;)
          if (o[0] === n.hashCharacter ? (i = 0, a = 0, o = o.substr(n.hashCharacter.length)) : (i = o.indexOf(n.separator + n.hashCharacter)) >= 0 && (o = o.substr(i + (n.separator + n.hashCharacter).length), a += i + n.separator.length), i >= 0) {
    ...
    M = function (e, t) {
      return function (n) {
        ...
        if ("atomic" === n.getType()) {
          ...
          if (r && "EMBEDDED_LINK" === r.type) return {
            component: a.default,
            editable: !1
          }
        }
  ...
  var p = function (e) {
    ...
    return n = t = function (t) {
      function n() {
        ...
        i(this, n);
        for (var M = arguments.length, c = Array(M), s = 0; s < M; s++) c[s] = arguments[s];
        return o = r = a(this, (t = n.__proto__ || Object.getPrototypeOf(n)).call.apply(t, [this].concat(c))), r.state = {
          hovered: !1
          ...
          i.mergeEntityData(a, {
            alignment: t
          }), e.onChange(u.EditorState.push(e.getEditorState(), i, "change-block-data")), r.setState({
            dummy: !0
          })
      ...
      return r(n, t), l(n, [{
        ...
        value: function (e) {
          ...
          }, "L"), c.default.createElement(D.default, {
            onClick: this.setEntityAlignmentCenter,
            className: "rdw-image-alignment-option"
          }, "C"), c.default.createElement(D.default, {
